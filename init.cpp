...
bool init()
{
    ...
    {
        cout << "Error initializing SDL_INIT_VIDEO, SDL ERR: " << SDL_GetError() << endl;
        return false;
    }
    ...
    // initialize window
    wWindow = SDL_CreateWindow("wiz", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
    ...
    {
        cout << "Error initializing window or renderer: SDL ERR: " << SDL_GetError() << endl;
        return false;
    }
